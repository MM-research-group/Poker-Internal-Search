...
# takes in csv, for each gamestate checks if potodds is applicable. if yes, it calculates the pot odds for that gamestate.
...
def is_pot_odds_applicable(row):
    ...
    try:
        ...
        moves = []
    # Pot odds apply if there is a 'Call' option (ignoring case)
