...
Below is a reasoning chain-of-thought explanation that should include both mathematical computations and board analysis. (If one or both are missing, please note that explicitly in your output.)
