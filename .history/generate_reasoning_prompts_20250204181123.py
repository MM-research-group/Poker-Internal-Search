...
- It is imperative that the final verified reasoning steps (explanation) does not include any reference to the optimal action. We want the optimal action to come after the reasoning steps. Remove any such details so that the reasoning stands alone.
