...
# this file processes all csvs in a directory. for both preflop and postflop gamestate configurations, it checks if potodds are applicable (aka does "call" exist in available_moves column?). 
# if yes, it calculates the pot odds for that gamestate.
