...
- It is imperative that the final verified reasoning steps (explanation) does not include any reference to, the optimal action. Remove any such details so that the reasoning stands alone.
