...
def main():
    ...
    with open("proposer_output.json", "w") as f:
    ...
    with open("math_board_output.json", "w") as f:
    ...
    with open("range_estimation_output.json", "w") as f:
    ...
    print("Pipeline processing complete. Check the generated JSON files for each module's output.")
