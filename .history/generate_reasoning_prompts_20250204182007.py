ddef prompt_proposer(gamestate, optimal_action):
    prompt = """
...
Please provide your output strictly in a structured JSON format with the following keys (and no additional text):
