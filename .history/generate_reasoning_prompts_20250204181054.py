...
- It is imperative that the final verified reasoning steps does not include any reference to, or information about, the optimal action. Remove any such details so that the reasoning stands alone.
