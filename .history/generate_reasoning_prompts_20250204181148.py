...
- Present a fully revised and integrated reasoning steps (chain-of-thought explanation) that is self-contained, free of any optimal action details, and adheres to poker best practices.
