...
- The potential ranges of your opponent’s hand
- Risk management and pot odds (when necessary)
- Your 
- Future street considerations and board texture

Only use factors if it makes sense Break down your reasoning step by step, and ensure that each part of your explanation logically follows from the game state and known poker strategies. Be careful to avoid speculative statements that are not grounded in standard poker theory.
...
Below is a section of a chain-of-thought explanation that should include both mathematical computations and board analysis. (If one or both are missing, please note that explicitly in your output.)
