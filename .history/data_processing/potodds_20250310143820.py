...
# this file processes all csvs in a directory. takes in csv, for each gamestate checks if potodds is applicable (aka does "call" exist in available_moves column?). if yes, it calculates the pot odds for that gamestate.
